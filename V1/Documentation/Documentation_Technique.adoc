...
La fonction essentiel au niveau de la modification des informations d'un client est la fonction modifierClient(Client c), qui se trouve dans ClientsManagement.java + 
...
Il n'y a, ici, aucune partie dans le code qui ait vraiment le mérite d'être signalées.

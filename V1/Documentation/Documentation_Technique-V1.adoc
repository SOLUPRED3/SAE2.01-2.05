...
===== a) Use case correspondant :
image::images/modifierCompte.svg[]
...
===== a) Use case correspondant :
image::images/crediterCompte.svg[]
...
===== a) Use case correspondant :
image::images/virementCompte.svg[]
...
===== a) Use case correspondant :
image::images/creerEmploye.svg[]


===== b) Partie du diagramme de classe correspondante :
image::images/modifierEmployeDC.png[]
...
===== a) Use case correspondant :
image::images/modifierInfoEmploye.svg[]
...
===== a) Use case correspondant :
image::images/voirInfoEmploye.svg[]
...
===== a) Use case correspondant :
image::images/rendreInactifEmploye.svg[]

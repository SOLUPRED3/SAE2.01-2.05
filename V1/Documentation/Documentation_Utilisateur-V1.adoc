...
image:images/DocumentationUser/gestionC1.png[gestionClient, 800, 500]

[.text-justify]
Vous arriverez ainsi sur cet onglet, qui vous permettra de faire toutes sortes d'actions concernant les clients :

image:images/DocumentationUser/gestionC2.png[gestionClient2, 800, 500]
...
image:images/DocumentationUser/gestionC3.png[gestionClient3, 800, 500]
...
image:images/DocumentationUser/gestionC4.png[gestionClient4, 800, 500]

[.text-justify]
Voici une recherche avec spécifications :

image:images/DocumentationUser/gestionC5.png[gestionClient5, 800, 500]
...
image:images/DocumentationUser/voirCl1.png[voirClient, 800, 500]
...
image:images/DocumentationUser/gestionC6.png[gestionClient6, 800, 500]
...
image:images/DocumentationUser/gestionC7.png[gestionClient7, 800, 500]
...
image:images/inactifCheck.png[clientInactif, 800, 500]
...
image:images/DocumentationUser/gestionC6.png[gestionCompte, 800, 500]

[.text-justify]
Vous vous trouverez face à cet onglet qui vous affiche les informations des différents comptes bancaires d'un client :

image:images/DocumentationUser/consC1.png[gestionCompte1, 800, 500]
...
image:images/DocumentationUser/consC2.png[gestionCompte2, 800, 500]

[.text-justify]
Saisissez le découvert autorisé ainsi que le solde du nouveau compte (son premier crédit).

image:images/DocumentationUser/consC3.png[créerCompte, 800, 500]
...
image:images/DocumentationUser/consC3.png[modifierCompte, 800, 500]
...
image:images/DocumentationUser/cl1.png[cloturerCompte, 800, 500]

[.text-justify]
Cliquez en suite sur le bouton "Clôturer compte" puis confirmez la clôturation.

image:images/DocumentationUser/cl2.png[cloturerCompte2, 800, 500]

image:images/DocumentationUser/cl3.png[cloturerCompte3, 800, 500]
...
image:images/DocumentationUser/consC4.png[gestionCompte4, 800, 500]
...
image:images/DocumentationUser/consC3.png[gestionCompte3, 800, 500]
...
image:images/DocumentationUser/cr1.png[créditer, 800, 500]
...
image:images/DocumentationUser/cr2.png[créditer2, 800, 500]
...
image:images/DocumentationUser/db1.png[débiter, 800, 500]
...
image:images/DocumentationUser/vr1.png[virement, 800, 500]
...
image:images/DocumentationUser/gEmp1.png[gérerEmployé1, 800, 500]

[.text-justify]
Vous arriverez ainsi sur cet onglet, qui vous permettra de faire toutes sortes d'actions concernant les employés :

image:images/DocumentationUser/gEmp2.png[gérerEmployé2, 800, 500]
...
image:images/DocumentationUser/rEmp3.png[gérerEmployé3, 800, 500]
...
image:images/DocumentationUser/rEmp1.png[gérerEmployé1, 800, 500]

[.text-justify]
Voici une recherche avec spécifications :

image:images/DocumentationUser/rEmp2.png[gérerEmployé2, 800, 500]
...
image:images/DocumentationUser/voirInfosEmpl.png[voirEmployé, 800, 500]
...
image:images/DocumentationUser/rEmp4.png[gérerEmployé4, 800, 500]

[.text-justify]
Vous verrez s'afficher cet onglet, il vous suffira de modifier les informations voulues et de les confirmer en appuyant sur "Modifier" :

image:images/DocumentationUser/rEmp5.png[gérerEmployé5, 800, 500]
...
image:images/inactifEmplCheck.png[employéInactif, 800, 500]
